...
static constexpr unsigned kIdesc = 144704640u;
static constexpr long long kWorkPerInstruction = 2097152LL;
static constexpr int kWarpsPerBlock = 4;
static constexpr int kThreads = 128;
static constexpr char kCaseId[] = "mxfp4_f32_m128n128k64_full_sm_4warp_block";
static constexpr char kPrecision[] = "mxfp4_f32";
...
__global__ __launch_bounds__(kThreads,1) void benchmark(
  ...
  for(int i=0;i<iters;++i){
    ...
    if((threadIdx.x&31)==0){
      asm volatile("{ .reg .pred p; setp.ne.b32 p,%4,0; tcgen05.mma.cta_group::1.kind::mxf4.block_scale.block32 [%0],%1,%2,%3,[%5],[%6],p; }"::"r"(dst),"l"(ad),"l"(bd),"r"(kIdesc),"r"(enable),"r"(tsa),"r"(tsb));
    }
  }
