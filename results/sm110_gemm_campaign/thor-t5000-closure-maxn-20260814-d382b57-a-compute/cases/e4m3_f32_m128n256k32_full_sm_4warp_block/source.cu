...
static constexpr unsigned kIdesc = 138412048u;
static constexpr long long kWorkPerInstruction = 2097152LL;
static constexpr int kWarpsPerBlock = 4;
static constexpr int kThreads = 128;
static constexpr char kCaseId[] = "e4m3_f32_m128n256k32_full_sm_4warp_block";
static constexpr char kPrecision[] = "e4m3_f32";
...
__global__ __launch_bounds__(kThreads,1) void benchmark(
  ...
  for(int i=0;i<iters;++i){
    ...
    if((threadIdx.x&31)==0){
      asm volatile("{ .reg .pred p; setp.ne.b32 p,%4,0; tcgen05.mma.cta_group::1.kind::f8f6f4 [%0],%1,%2,%3,{%5,%6,%7,%8},p; }"::"r"(dst),"l"(ad),"l"(bd),"r"(kIdesc),"r"(enable),"r"(0),"r"(0),"r"(0),"r"(0));
    }
  }
