...
#include <cutlass/epilogue/collective/sm100_epilogue_array_planar_complex_tma_warpspecialized.hpp>
...
namespace guide::codegen::ptr_array_planar_complex_f16_2sm {
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelPtrArrayTmaWarpSpecialized2SmPlanarComplexSm100;
  using EpilogueSchedule = cutlass::epilogue::PtrArrayPlanarComplexTmaWarpSpecialized2Sm;
  using EpilogueTile = cutlass::epilogue::collective::EpilogueTileAuto;
  using FusionOperation = void;
  using ProblemShape = cutlass::gemm::ArrayProblemShape<cute::Shape<int,int,int,int>>;
