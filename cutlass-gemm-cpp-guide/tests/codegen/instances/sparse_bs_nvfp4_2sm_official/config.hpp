...
namespace guide::codegen::sparse_bs_nvfp4_2sm_official {
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelSparseTmaWarpSpecialized2SmNvf4Sm100;
  using EpilogueSchedule = cutlass::epilogue::TmaWarpSpecialized2SmNvf4;
