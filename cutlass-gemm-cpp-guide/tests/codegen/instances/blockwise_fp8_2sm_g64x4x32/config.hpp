...
namespace guide::codegen::blockwise_fp8_2sm_g64x4x32 {

using ScaleConfig = cutlass::detail::Sm100BlockwiseScaleConfig<64,4,32,cute::UMMA::Major::MN,cute::UMMA::Major::MN>;
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelTmaWarpSpecializedBlockwise2SmSm100;
