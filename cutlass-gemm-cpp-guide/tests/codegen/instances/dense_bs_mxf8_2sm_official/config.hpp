...
namespace guide::codegen::dense_bs_mxf8_2sm_official {
...
struct Config {
  ...
  using BuilderElementA = cutlass::mx_float8_t<cutlass::float_e4m3_t>;
  using BuilderElementB = cutlass::mx_float6_t<cutlass::float_e3m2_t>;
  ...
  using MmaTileShape = cute::Shape<cute::_256,cute::_192,cute::_128>;
