...
namespace guide::codegen::fast_fp32_bf16x9_2sm_smem {
...
struct Config {
  ...
  using BuilderElementA = float;
  using BuilderElementB = float;
  ...
  using MmaTileShape = cute::Shape<cute::_256,cute::_128,cute::_16>;
  ...
  using EpilogueSchedule = cutlass::epilogue::FastF32NoSmemWarpSpecialized2Sm;
