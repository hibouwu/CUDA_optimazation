...
namespace guide::codegen::sparse_i8_1sm_official {
...
struct Config {
  ...
  using MainloopOperatorClass = cutlass::arch::OpClassSparseTensorOp;
  using EpilogueOperatorClass = cutlass::arch::OpClassSparseTensorOp;
  using BuilderElementA = int8_t;
  using BuilderElementB = int8_t;
  using BuilderLayoutA = cutlass::layout::RowMajor;
  using BuilderLayoutB = cutlass::layout::ColumnMajor;
  using EpilogueElementC = int8_t;
  using EpilogueElementD = int8_t;
  using EpilogueLayoutC = cutlass::layout::ColumnMajor;
  using EpilogueLayoutD = cutlass::layout::ColumnMajor;
  using MmaTileShape = cute::Shape<cute::_128,cute::_64,cute::_128>;
  using ClusterShape = cute::Shape<cute::_1,cute::_1,cute::_1>;
  using ClusterDefaultShape = cute::Shape<cute::_1,cute::_1,cute::_1>;
  using MainloopSchedule = cutlass::gemm::KernelSparseTmaWarpSpecialized1SmSm100;
  using EpilogueSchedule = cutlass::epilogue::TmaWarpSpecialized1Sm;
  using EpilogueTile = cutlass::epilogue::collective::EpilogueTileAuto;
  using FusionOperation = cutlass::epilogue::fusion::LinearCombination<int8_t,float,int8_t,float>;
