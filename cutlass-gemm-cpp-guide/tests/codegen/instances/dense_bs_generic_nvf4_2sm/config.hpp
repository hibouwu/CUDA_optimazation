...
namespace guide::codegen::dense_bs_generic_nvf4_2sm {
...
struct Config {
  ...
  using BuilderElementA = cutlass::nv_float4_t<cutlass::float_e2m1_t>;
  using BuilderElementB = cutlass::nv_float4_t<cutlass::float_e2m1_t>;
  using BuilderLayoutA = cutlass::layout::RowMajor;
  using BuilderLayoutB = cutlass::layout::ColumnMajor;
  using EpilogueElementC = cutlass::bfloat16_t;
  using EpilogueElementD = cutlass::bfloat16_t;
  ...
  using ClusterDefaultShape = cute::Shape<cute::_2,cute::_4,cute::_1>;
  using MainloopSchedule = cutlass::gemm::KernelTmaWarpSpecialized2SmBlockScaledSm100;
