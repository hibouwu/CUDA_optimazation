...
namespace guide::codegen::ptr_array_blockwise_fp8_2sm_g1x128x128 {

using ScaleConfig = cutlass::detail::Sm100BlockwiseScaleConfig<1,128,128,cute::UMMA::Major::MN,cute::UMMA::Major::MN>;
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelPtrArrayTmaWarpSpecializedBlockwise2SmSm100;
