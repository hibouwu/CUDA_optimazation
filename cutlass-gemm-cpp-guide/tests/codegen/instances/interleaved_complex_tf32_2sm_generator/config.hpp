...
namespace guide::codegen::interleaved_complex_tf32_2sm_generator {
...
struct Config {
  ...
  using BuilderElementA = cute::tuple<cutlass::complex<float>, cute::identity>;
  using BuilderElementB = cute::tuple<cutlass::complex<float>, cute::identity>;
  ...
  using MmaTileShape = cute::Shape<cute::_256,cute::_64,cute::_16>;
  using ClusterShape = cute::Shape<cute::_2,cute::_1,cute::_1>;
  using ClusterDefaultShape = cute::Shape<cute::_2,cute::_1,cute::_1>;
  using MainloopSchedule = cutlass::gemm::KernelTmaWarpSpecialized2SmInterleavedComplexTF32Sm100;
