...
namespace guide::codegen::sparse_bs_mxf4_1sm_official {
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelSparseTmaWarpSpecialized1SmMxf4Sm100;
  using EpilogueSchedule = cutlass::epilogue::TmaWarpSpecialized1SmMxf4;
