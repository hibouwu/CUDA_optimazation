...
namespace guide::codegen::ptr_bs_mxf8_2sm_official {
...
struct Config {
  ...
  using BuilderElementA = cute::tuple<cutlass::float_e2m3_t,cutlass::float_ue8m0_t>;
  using BuilderElementB = cute::tuple<cutlass::float_e2m3_t,cutlass::float_ue8m0_t>;
  using BuilderLayoutA = cutlass::layout::RowMajor;
  using BuilderLayoutB = cutlass::layout::ColumnMajor;
  using EpilogueElementC = float;
  ...
  using ClusterDefaultShape = cute::Shape<cute::_2,cute::_2,cute::_1>;
