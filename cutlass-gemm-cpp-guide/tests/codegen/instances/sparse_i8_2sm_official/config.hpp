...
namespace guide::codegen::sparse_i8_2sm_official {
...
struct Config {
  ...
  using MmaTileShape = cute::Shape<cute::_256,cute::_64,cute::_128>;
  using ClusterShape = cute::Shape<cute::_2,cute::_1,cute::_1>;
  using ClusterDefaultShape = cute::Shape<cute::_2,cute::_1,cute::_1>;
  using MainloopSchedule = cutlass::gemm::KernelSparseTmaWarpSpecialized2SmSm100;
