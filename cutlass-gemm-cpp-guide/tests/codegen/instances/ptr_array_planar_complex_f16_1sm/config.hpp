...
namespace guide::codegen::ptr_array_planar_complex_f16_1sm {
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelPtrArrayTmaWarpSpecialized1SmPlanarComplexSm100;
  using EpilogueSchedule = cutlass::epilogue::PtrArrayPlanarComplexTmaWarpSpecialized1Sm;
