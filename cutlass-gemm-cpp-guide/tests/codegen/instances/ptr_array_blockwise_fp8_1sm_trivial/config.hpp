...
namespace guide::codegen::ptr_array_blockwise_fp8_1sm_trivial {

using ScaleConfig = cutlass::detail::Sm100BlockwiseScaleConfig<128,128,128,cute::UMMA::Major::MN,cute::UMMA::Major::MN>;
...
struct Config {
  ...
  using MainloopSchedule = cutlass::gemm::KernelPtrArrayTmaWarpSpecializedBlockwise1SmSm100;
