...
#### <sup>1</sup>Princeton University, <sup>2</sup>Together AI, <sup>3</sup>Meta, <sup>4</sup>Colfax Research, <sup>5</sup>NVIDIA, <sup>6</sup>Georgia Tech
...
### Faster exponential: Distribute across MUFU.EX2 and FMA (software emulation) $2^x$
