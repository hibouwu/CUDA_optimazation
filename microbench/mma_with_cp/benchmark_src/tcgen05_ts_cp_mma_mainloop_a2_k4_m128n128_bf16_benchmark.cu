...
static constexpr int kMmaIssuerCount = 4;
static constexpr int kCpIssuerCount = 4;
...
static constexpr char kCaseId[] = "ts_cp_mma_mainloop_a2_k4";
static constexpr char kCaseLabel[] = "TS CP+MMA Mainloop A2 K4";
