...
static constexpr int kMmaIssuerCount = 8;
static constexpr int kCpIssuerCount = 8;
...
static constexpr int kMainloopKBlocks = 8;
...
static constexpr char kCaseId[] = "ts_cp_mma_mainloop_a2_k8";
static constexpr char kCaseLabel[] = "TS CP+MMA Mainloop A2 K8";
