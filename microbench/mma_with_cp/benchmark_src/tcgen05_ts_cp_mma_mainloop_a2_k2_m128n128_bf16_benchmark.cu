...
static constexpr int kMmaIssuerCount = 2;
static constexpr int kCpIssuerCount = 2;
...
static constexpr int kMainloopKBlocks = 2;
...
static constexpr char kCaseId[] = "ts_cp_mma_mainloop_a2_k2";
static constexpr char kCaseLabel[] = "TS CP+MMA Mainloop A2 K2";
