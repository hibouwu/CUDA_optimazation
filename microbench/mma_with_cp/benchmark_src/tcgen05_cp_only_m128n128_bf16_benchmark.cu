...
static constexpr int kMmaIssuerCount = 0;
...
static constexpr char kCaseId[] = "tcgen05_cp_only";
static constexpr char kCaseLabel[] = "tcgen05.cp-only";
...
int main(int argc, char** argv) {
  ...
  long long mma_instruction_count = 0LL;
