...
static constexpr int kMmaIssuerCount = 16;
static constexpr int kCpIssuerCount = 16;
...
static constexpr char kCaseId[] = "ts_cp_mma_mainloop_a2_k16";
static constexpr char kCaseLabel[] = "TS CP+MMA Mainloop A2 K16";
...
void tcgen05_kernel(int iters, unsigned long long* cycles_out) {
  ...
  __shared__ alignas(16) uint8_t smem_b[65536];
