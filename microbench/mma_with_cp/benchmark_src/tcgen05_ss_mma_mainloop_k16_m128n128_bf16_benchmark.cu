...
static constexpr int kCpIssuerCount = 0;
static constexpr int kProcessedTilesPerIter = 0;
static constexpr int kCpInstructionsPerTile = 0;
...
static constexpr char kCaseId[] = "ss_mma_mainloop_k16";
static constexpr char kCaseLabel[] = "SS MMA Mainloop K16";
...
int main(int argc, char** argv) {
  ...
  long long cp_instruction_count = 0LL;
  long long processed_tiles = 0LL;
