...
static constexpr int kNoiseCpPerMma = 8;
...
static constexpr char kCaseId[] = "ts_mainloop_a2_k16_extra_cp_split_n8";
static constexpr char kCaseLabel[] = "TS A2 mainloop K16 + extra cp split issuer n8";
