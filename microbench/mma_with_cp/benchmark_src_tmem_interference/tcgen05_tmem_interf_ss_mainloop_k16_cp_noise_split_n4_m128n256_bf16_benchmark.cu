...
static constexpr int kInitialBarrierArriveCount = 2;
...
static constexpr char kCaseId[] = "ss_mainloop_k16_cp_noise_split_n4";
static constexpr char kCaseLabel[] = "SS mainloop K16 + cp noise split issuer n4";
