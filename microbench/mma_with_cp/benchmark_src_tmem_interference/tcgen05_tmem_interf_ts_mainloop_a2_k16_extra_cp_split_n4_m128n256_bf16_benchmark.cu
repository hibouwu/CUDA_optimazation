...
static constexpr int kNoiseCpPerMma = 4;
...
static constexpr char kCaseId[] = "ts_mainloop_a2_k16_extra_cp_split_n4";
static constexpr char kCaseLabel[] = "TS A2 mainloop K16 + extra cp split issuer n4";
