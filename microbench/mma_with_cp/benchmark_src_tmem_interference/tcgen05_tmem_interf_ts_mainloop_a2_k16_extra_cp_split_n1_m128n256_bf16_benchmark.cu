...
static constexpr int kNoiseCpPerMma = 1;
static constexpr int kRequiredCpPerMma = 1;
...
static constexpr char kCaseId[] = "ts_mainloop_a2_k16_extra_cp_split_n1";
static constexpr char kCaseLabel[] = "TS A2 mainloop K16 + extra cp split issuer n1";
static constexpr char kMmaPath[] = "TS";
static constexpr char kIssueMode[] = "split";
